            ...
            <div class="footer__container">
                ...
                <ul class="footer-category__list">
                    ...
                    <h3 class="footer-category__subtitle">
                        <a class="footer-link" href="#">Женщины</a>
                    </h3>
                    <ul class="footer-category__sublist">
                        <li class="footer-category__subitem">
                        <a href="#" class="footer-link">Бюстгальтеры</a>
                        </li>
                        <li class="footer-category__subitem">
                        <a href="#" class="footer-link">Трусы</a>
                        </li>
                        <li class="footer-category__subitem">
                        <a href="#" class="footer-link">Носки</a>
                        </li>
                        <li class="footer-category__subitem">
                        <a href="#" class="footer-link">Халаты</a>
                        </li>
                        <li class="footer-category__subitem">
                        <a href="#" class="footer-link">Термобелье</a>
                        </li>
                        <li class="footer-category__subitem">
                        <a href="#" class="footer-link">Пижамы</a>
                        </li>
                    </ul>
                    </li>
                    <li class="footer-category__item">
                    <h3 class="footer-category__subtitle">
                        <a class="footer-link" href="#">Мужчины</a>
                    </h3>
                    <ul class="footer-category__sublist">
                        <li class="footer-category__subitem">
                        <a href="#" class="footer-link">Трусы</a>
                ...
                <ul class="footer-social__list">
                    ...
                    <a href="#" class="footer-social__link footer-social__link_vk footer-link">
                    ...
                    <li class="footer-social__item">
                    <a href="#" class="footer-social__link footer-social__link_fb footer-link">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                ...
                <a class="footer__link footer-link" href="mailto:Inspired@gmail.com">Inspired@gmail.com</a>
                <a class="footer__link footer-link" href="tel:89304902620">8 930 490 26 20</a>
                </div>
                <div class="footer__item footer__item_copyright footer-copyright">
                <p class="">© INSPIRED, 2023</p>
                </div>
                ...
                <ul class="footer-development__list">
                    ...
                    Designer: <a class='footer-link' href="#">Anastasia Ilina</a>
                    </li>
                    <li class="footer-development__item">
                    Developer: <a class='footer-link' href="#">Andrew</a>
                    </li>
                </ul>
                </div>
            </div>
